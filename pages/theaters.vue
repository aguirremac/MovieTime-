<template>
  <div class="mx-auto w-1444px min-h-screen h-full text-start text-20px font-normal px-31px md:px-80px">
      ...
      <div class="hidden md:flex items-center w-full h-46px bg-#030303 rounded-lg  mt-18px mb-0">
          <p class="text-center xl:text-start text-8px md:text-12px lg:text-16px font-normal px-24px py-14px ">Turn on <span class="font-bold">Location Services</span> to find cinema theaters nearest you!</p>
      </div>
      ...
      <div class="w-full h-full flex flex-wrap justify-center gap-10px ">
        ...
        <div  v-for ="(cinema, index) in sortedCinemaDetails"
              :key="index"
              class="flex  w-350px h-150px xl:w-624px xl:h-183px bg-#262626 rounded-xl mt-14px">
                <!-- left part -->
            <div class="">
              ...
              <div class="flex gap-14px w-full pt-10px xl:pt-23px pl-18px xl:pl-26px">
               ...
               <!-- time slots -->
            <div class="pl-20px xl:pl-27px pr-75px xl:pr-150px  flex flex-wrap w-full  gap-x-15px xl:gap-x-26px mt-10px xl:mt-15px" >
